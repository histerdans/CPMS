...
<nav class="navbar-inverse" style="background-image:url('../Assets/image/real.png'); position: relative; left:0px;top:0px;width:1348.5px; height:50px;">
  ...
  <div style="background-color:#ABD9F2;position: absolute; left: 30px;top:80px;width:650px;">
    ...
    <form action="../Apps/connAgenda.php" id="contact-form" class="form-horizontal" method = "POST">
      ...
      <legend class="text-center">Report corruption</legend>
      
      <input  type="hidden" name="corruption" value="corruption">
      ...
      <div class="control-group"style="position: absolute; left: 10px;top:80px;width:600px;background-color:#ABD9F2;">
        ...
        <div class="controls">
          ...
          <select name = "issue" id = "select" class="input-xlarge" required>
            <option value = "">Corruption in? </option>
      ...
      <div class="control-group" style="position: absolute; left:10px;top:230px;width:600px;background-color:#ABD9F2;">
        ...
        <div class="controls">
          <textarea class="input-xxlarge" name="description" id="message" rows="3" placeholder = "Draft your Issue here ..." required></textarea>
        </div>
  ...
  <div class="scroll">
    ...
    <fieldset class="">
      <legend class="text-center">Recent Reportted Corruption</legend>
      <?php

      include('../Connections/connect.php');

      $query = "SELECT * FROM s_corruption where Q_comment !='' order by date_saved desc limit 5";
