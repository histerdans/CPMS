...
if(isset($_GET['ID'])){
	...
	while ($row = mysql_fetch_array($query)) {
		...
		$insert = "INSERT INTO users(username,password,Email,Company,Project_Name,firstname,lastname,user_role)VALUES('$username','$password','$email','$company','$pname','$fname','$lname','$urole')";
