...
<body>
	<div class="navbar navbar-inverse">
		<div class="navbar-inner">
          ...
          <label style="position: absolute; left: 890px;top:34px;width:300px; color:#efd506;"><?php echo $t;?>&nbsp;<?php echo $fname; ?>&nbsp;<?php echo $lname; ?> </label><ul class="nav ace-nav pull-right"><p>
              ...
              <div class="media-body hidden-tablet">
                ...
                <ul class="unstyled user-info">
                  <li>Logged in as <br/><?php echo $row_AdminPanel_recordset['user_role'];
                    echo "</br>";
                    echo $row_AdminPanel_recordset['Constituency'];
                    $cont=$row_AdminPanel_recordset['Constituency'];
                    $role=$row_AdminPanel_recordset['user_role']; ?></li>
                    <li class="divider"></li>
                ...
                <ul class="nav nav-list">
                  ...
                  <li class="active">
                    ...
                    <ul class="submenu">
                      <li><a href="L_complain.php"><i class="icon-double-angle-right"></i>Complains</a></li>
                      <li><a href="L_suggestion.php"><i class="icon-double-angle-right"></i>Suggestions</a></li>
                      <li><a href="L_inquiry.php"><i class="icon-double-angle-right"></i>Inquiries</a></li>
                      <li><a href="L_recommendation.php"><i class="icon-double-angle-right"></i>Recommendations</a></li>
                      <li><a href="L_corruption.php"><i class="icon-double-angle-right"></i>Reported Corruption</a></li>
                      <li><a href="L_disaster.php"><i class="icon-double-angle-right"></i>Reported Disaster</a></li>
                    </ul>
                  </li>
