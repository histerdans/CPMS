...
mysql_select_db($database_localhost, $localhost1);
$query_Admin = sprintf("SELECT * FROM budget ");
$Admin = mysql_query($query_Admin, $localhost1) or die(mysql_error());
$row_Admin = mysql_fetch_assoc($AdminPanel_recordset);
$totalRows_Admin = mysql_num_rows($AdminPanel_recordset);
$bR=$row_Admin['BudgetR'];
						...
						<div class="media-body hidden-tablet">
							...
							<ul class="unstyled user-info">
								<li>Logged in as<br/> <?php echo $row_AdminPanel_recordset['user_role'];
									...
									$Dep=$row_AdminPanel_recordset['Department']; ?></li>
									<li class="divider"></li>
							...
							<ul class="nav nav-list">
								...
								<li>
									...
									<ul class="submenu">
										...
										<li><a href="A6.php"><i class="icon-double-angle-right"></i>Budget</a></li>
										<li><a href="A5.php"><i class="icon-double-angle-right"></i>Budget Allocation</a></li>
										<li><a href="../../AdminAccess/AdminFiles/Budgettlb.php"><i class="icon-double-angle-right"></i>Budget Details</a></li>
