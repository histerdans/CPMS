							...
							<div class="media-body hidden-tablet">
								...
								<ul class="nav nav-list">
									...
									<li class="active">
										...
										<ul class="submenu">
											<li><a href="Q_complains.php"><i class="icon-double-angle-right"></i>Complains</a></li>
											<li><a href="Q_suggestion.php"><i class="icon-double-angle-right"></i>Suggestions</a></li>
											<li><a href="Q_inquiry.php"><i class="icon-double-angle-right"></i>Inquiries</a></li>
											<li><a href="Q_recommendation.php"><i class="icon-double-angle-right"></i>Recommendations</a></li>
											<li><a href="Q_corruption.php"><i class="icon-double-angle-right"></i>Reported Corruption</a></li>
											<li><a href="Q_disaster.php"><i class="icon-double-angle-right"></i>Reported Disaster</a></li>
										</ul>
									</li>
