...
$urole=$row_AdminPanel_recordset['user_role'];
$Pname=$row_AdminPanel_recordset['Project_Name'];
							...
							<div class="media user-media hidden-phone">
								...
								<div class="media-body hidden-tablet">
									...
									<ul class="unstyled user-info">
										<li>Logged in as <br/>
											<?php echo $row_AdminPanel_recordset['user_role'];
									...
									<ul class="nav nav-list">
										...
										<li>
											...
											<ul class="submenu">
												...
												<li><a href="A4.php"><i class="icon-double-angle-right"></i>Resource Allocation</a></li>
