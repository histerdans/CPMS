							...
							<div class="media user-media hidden-phone">
								...
								<div class="media-body hidden-tablet">
									...
									<ul class="unstyled user-info">
										<li>Logged in as:<?php echo $row_QA['user_role'];
								...
								<ul class="nav nav-list">
									...
									<li>
										...
										<ul class="submenu">
										<li><?php echo "<a href=\"Activity/A2.php?Dep=$min\">"; echo '<i class="icon-double-angle-right"></i>Resource Planning</a>';?></li>
										<li><?php echo "<a href=\"Activity/A2.php?Dep=$min\">"; echo '<i class="icon-double-angle-right"></i>Resource Allocation</a>';?></li>
										</ul>
									</li>
								</ul><!--/.nav-list-->
