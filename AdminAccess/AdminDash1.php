		...
		<div class="navbar  nav navbar-inverse">
			<div class="navbar-inner">
				<div class="container-fluid">
					...
					<div class = "span8">
						<a class="brand" href="#"><small><img src="../Assets/image/logo.png" style="position: absolute; left: 4px;top:0px;width:50px;" alt="CPMS Logo"> </img> .............. County  Permomance and Monitoring System (CPMS)</small> </a></div>
						...
						<ul class="nav ace-nav pull-right"><p>
							<li class="light-blue user-profile">
								...
								<a class="user-menu dropdown-toggle badge-tooltip-error" title="Click the OFF icon to Make changes to your profile and/or log out the system to user Homepage" href="AdminDash1.php" data-toggle="dropdown">
					...
					<div class="container-fluid" id="main-container">
						<a href="AdminDash1.php" id="menu-toggler"><span></span></a><!-- menu toggler -->
						...
						<div id="sidebar">
							<div class="media user-media hidden-phone">
								...
								<div class="media-body hidden-tablet">
									...
									<ul class="unstyled user-info">
										...
										$cont=$row_QA['Constituency'];?><br/><?php echo $Dep?></li>
										<li class="divider"></li>
								...
								<ul class="nav nav-list">
									...
									<li class="active">
										<a href="AdminDas1.php" class="dropdown-toggle badge-tooltip-error" title="Your Dashboard, Contains all the new Notification">
									...
									<li>
										<a href="AdminDash1.php" class="dropdown-toggle badge-tooltip-error" title="Tables of Recent Agendas" >
											<i class="icon-bar-chart"></i>
											<span >Recent Activities</span>
											<b class="arrow icon-angle-down"></b>
										</a>
										<ul class="submenu">
											<li><a href="AdminFiles/L_complain.php"><i class="icon-double-angle-right"></i>Complains</a></li>
											<li><a href="AdminFiles/L_suggestion.php"><i class="icon-double-angle-right"></i>Suggestions</a></li>
											<li><a href="AdminFiles/L_inquiry.php"><i class="icon-double-angle-right"></i>Inquiries</a></li>
											<li><a href="AdminFiles/L_recommendation.php"><i class="icon-double-angle-right"></i>Recommendations</a></li>
											<li><a href="AdminFiles/L_corruption.php"><i class="icon-double-angle-right"></i>Reported Corruption</a></li>
											<li><a href="AdminFiles/L_disaster.php"><i class="icon-double-angle-right"></i>Disasters</a></li>
										</ul>
									</li>
							...
							<div id="main-content" class="clearfix">
								...
								<div id="page-content" class="clearfix">
									...
									$resultc = mysql_query("SELECT * FROM s_complains where Q_comment = '' AND fwd_to='$role' AND f_Constituency='$cont'");
									$comp =mysql_num_rows($resultc);
									$resultcr = mysql_query("SELECT * FROM s_corruption where Q_comment = '' AND fwd_to='$role' AND f_Constituency='$cont'");
									$corr =mysql_num_rows($resultcr);
									$resulti = mysql_query("SELECT * FROM s_inquiries where Q_comment = '' AND fwd_to='$role' AND f_Constituency='$cont'");
									$inqr =mysql_num_rows($resulti);
									$results = mysql_query("SELECT * FROM s_suggestion  where Q_comment = '' AND fwd_to='$role' AND f_Constituency='$cont'");
									$sugg =mysql_num_rows($results);
									$resultr = mysql_query("SELECT * FROM s_recommendation  where Q_comment = '' AND fwd_to='$role' AND f_Constituency='$cont'");
									$recmm =mysql_num_rows($resultr);
									$resultd = mysql_query("SELECT * FROM s_disaster where Q_comment = '' AND fwd_to='$role' AND f_Constituency='$cont'");
									...
									<a class="muted" href="#comp" data-toggle="tab">
										...
										<a class="muted" href="#sugg" data-toggle="tab">
											...
											<a class="muted" href="#inqr" data-toggle="tab">
												...
												<a class="muted" href="#recmm" data-toggle="tab">
													...
													<a class="muted" href="#disas" data-toggle="tab">
														...
														<div class="span11">
															...
															<div class="widget-box transparent">
																...
																<div class="widget-body">
																	<div class="widget-main no-padding">
																		<div class="tab-content no-padding">
																			...
																			<div id="comp" class="tab-pane">
																				...
																				<?php
																				$query = "SELECT * FROM s_complains where Q_comment = '' AND fwd_to='$role' AND f_Constituency='$cont' order by date_saved desc ";
																				...
																				<a href="AdminFiles/L_complain.php" class="btn btn-minier btn-info"><i class="icon-only icon-share-alt"></i></a>
																			</div>';
																			echo '</div>';
																			echo '</div>';
																			echo '</div>';
																	...
																	<div id="disas" class="tab-pane">
																		...
																		<?php
																		$query = "SELECT * FROM s_disaster where Q_comment = ''AND fwd_to='$role' AND f_Constituency='$cont'  order by date_saved desc";
																		...
																		echo '<div class="text">'.$message .'</div>';
																		echo '<div class="tools">
																		<a href="AdminFiles/L_disaster.php" class="btn btn-minier btn-info"><i class="icon-only icon-share-alt"></i></a>
																	</div>';
																	echo '</div>';
																	echo '</div>';
																	echo '</div>';
															...
															<div id="inqr" class="tab-pane">
																...
																<?php
																$query = "SELECT * FROM s_inquiries where Q_comment = '' AND fwd_to='$role' AND f_Constituency='$cont'order by date_saved desc ";
																...
																echo '<div class="text">'.$message .'</div>';
																echo '<div class="tools">
																<a href="AdminFiles/L_inquiry.php" class="btn btn-minier btn-info"><i class="icon-only icon-share-alt"></i></a>
															</div>';
															echo '</div>';
															echo '</div>';
															echo '</div>';
													...
													<div id="recmm" class="tab-pane">
														...
														<?php
														$query = "SELECT * FROM s_recommendation where Q_comment = '' AND fwd_to='$role' AND f_Constituency='$cont' order by date_saved desc  ";
														...
														echo '<div class="text">'.$message .'</div>';
														echo '<div class="tools">
														<a href="AdminFiles/L_recommendation.php" class="btn btn-minier btn-info"><i class="icon-only icon-share-alt"></i></a>
													</div>';
													echo '</div>';
													echo '</div>';
													echo '</div>';
											...
											<div id="sugg" class="tab-pane">
												...
												<?php
												$query = "SELECT * FROM s_suggestion where Q_comment = '' AND fwd_to='$role' AND f_Constituency='$cont'  order by date_saved desc  ";
												...
												echo '<div class="text">'.$message .'</div>';
												echo '<div class="tools">
												<a href="AdminFiles/L_suggestion.php" class="btn btn-minier btn-info"><i class="icon-only icon-share-alt"></i></a>
											</div>';
											echo '</div>';
											echo '</div>';
											echo '</div>';
									...
									<div id="corr" class="tab-pane">
										...
										<?php
										$query = "SELECT * FROM s_corruption where Q_comment = '' AND fwd_to='$role' AND f_Constituency='$cont'  order by date_saved desc  ";
										$results = mysql_query($query,$localhost1);
										while($row=mysql_fetch_array($results)){ 
										...
										echo '<div class="text">'.$message .'</div>';
										echo '<div class="tools">
										<a href="AdminFiles/L_corruption.php" class="btn btn-minier btn-info"><i class="icon-only icon-share-alt"></i></a>
									</div>';
									echo '</div>';
									echo '</div>';
									echo '</div>';
