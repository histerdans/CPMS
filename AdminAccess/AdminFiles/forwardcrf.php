  ...
  <div id="page-content" class="clearfix">
    ...
    <form name="forward" action="../../Apps/connfwd.php" method="POST">
      <div class="span4 pull-right">
        <?php 
        $Agenda_fidcr=$_GET['Agenda_fidcr'];
        $query = "SELECT * FROM s_corruption WHERE Agenda_id=$Agenda_fidcr";
        ...
        while ($row = mysql_fetch_array($resultc)) {
          ...
          $descrp=$row['descriptrruption'];
          $email=$row['email'];
          $issue=$row['issue'];

          echo'<input type="hidden" name="Agenda_fidcr" value="'.$Agenda_fidcr.'">';
