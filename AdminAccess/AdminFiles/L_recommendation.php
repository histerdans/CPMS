		...
		<div class="row-fluid">
			...
			<table id="table_AD1" class="table table-striped table-bordered table-hover">
				...
				<tbody>
					...
					$query = "SELECT * FROM s_recommendation where  fwd_to='$role' AND Q_comment='' AND f_Constituency='$cont' order by Agenda_id desc ";
					$results = mysql_query($query,$localhost1);
					while ($row = mysql_fetch_array($results)) {
						$Agenda_lidr = $row['Agenda_id'];
						...
						echo "<a href=\"replyrl.php?Agenda_lidr=$Agenda_lidr\">";
