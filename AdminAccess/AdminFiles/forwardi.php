  ...
  <div id="page-content" class="clearfix">
    ...
    <form name="forward" action="../../Apps/connfwd.php" method="POST">
      <div class="span4 pull-right">
        <?php 
        $Agenda_idi=$_GET['Agenda_idi'];
        $query = "SELECT * FROM s_inquiries WHERE Agenda_id=$Agenda_idi";
        ...
        while ($row = mysql_fetch_array($resultc)) {
          ...
          echo'<input type="hidden" name="Agenda_idi" value="'.$Agenda_idi.'">';
          ...
          echo'<lable><b>Email</b></lable><div>'.$email.'</div><hr>';
      ...
      <div class="span6 widget-container-span ">
        ...
        <script type="text/javascript">
          function checkif(){
            if(document.forward.User_role.value=='CS')
              document.forward.Ministry.disabled=true;
            document.forward.Constituency.disabled=true;
            
            
            else if(document.forward.User_role.value=='GOV')
              document.forward.Ministry.disabled=true;
            document.forward.Constituency.disabled=true;
            
            else
              document.forward.Ministry.disabled=false;
            document.forward.Constituency.disabled=false;
          }
