		...
		<div class="row-fluid">
			...
			<table id="table_AD1" class="table table-striped table-bordered table-hover">
				...
				<tbody>
					...
					$query = "SELECT * FROM s_corruption where  fwd_to='$role' AND Q_comment='' AND f_Constituency='$cont' order by Agenda_id desc ";
					 $resultc = mysql_query($query,$localhost1);

        while ($row = mysql_fetch_array($resultc)) {
          
							$Agenda_lidcr = $row['Agenda_id'];
							...
							echo "<a href=\"replycrl.php?Agenda_lidcr=$Agenda_lidcr\">";
