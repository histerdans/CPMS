        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Update Post Article</h4>

                </div>

                <div class="modal-body">
                    <form id="contact-form" class="form-horizontal" action="../../Apps/connAsU.php" method="post" >
                        <fieldset>
                            <?php
                            ...
                            <div class="Container">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                    <input type="text" id="form-field-1" name="pTitle" placeholder="Title" value="<?php echo $pT; ?>" required />
