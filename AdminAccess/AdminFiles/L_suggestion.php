		...
		<div class="row-fluid">
			...
			<table id="table_AD1" class="table table-striped table-bordered table-hover">
				...
				<tbody>
					...
					$query = "SELECT * FROM s_suggestion where  fwd_to='$role' AND Q_comment='' AND f_Constituency='$cont' order by Agenda_id desc ";
					$results = mysql_query($query,$localhost1);
					while ($row = mysql_fetch_array($results)) {
						$Agenda_lids = $row['Agenda_id'];
						...
						echo "<a href=\"replysl.php?Agenda_lids=$Agenda_lids\">";
