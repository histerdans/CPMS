	...
	<div id="page-content" class="clearfix">
		...
		<div class="row-fluid">
			...
			<div class="table-header">
				Results for "Latest Corruption Reported"
			</div>
			...
			<table id="table_QA" class="table table-striped table-bordered table-hover">
				...
				<tbody>
					...
					$query = "SELECT * FROM s_corruption order by Agenda_id desc";
					$result = $localhost2->query($query);
					if ($result->num_rows > 0) {

						while($row = $result->fetch_assoc()) {
							$Agenda_idcr = $row['Agenda_id'];
							...
							echo "<a href=\"replycr.php?Agenda_idcr=$Agenda_idcr\">";
							echo			'<button class="btn btn-mini btn-success"><i class="icon-ok">Reply</i></button>';
							echo "</a>";
							echo "<a href=\"forwardcr.php?Agenda_idcr=$Agenda_idcr\">";
							echo			'<button class="btn btn-mini btn-info"><i class="icon-edit">forward</i></button>';
							echo "</a>";
							echo "<a href=\"../../Apps/connDel.php?Agenda_idcr=$Agenda_idcr\">";?>
