						...
						<div id="sidebar">
							<div class="media user-media hidden-phone">
								...
								<ul class="nav nav-list">
									...
									<li class="active">
										<a href="QA.php" class="dropdown-toggle badge-tooltip-error" title="Your Dashboard, Contains all the new Notification">
									...
									<li>
										<a href="QA.php" class="dropdown-toggle badge-tooltip-error" title="Tables of Recent Agendas" >
											<i class="icon-bar-chart"></i>
											<span >Recent Activities</span>
											<b class="arrow icon-angle-down"></b>
										</a>
										<ul class="submenu">
											<li><a href="AdminFiles/Q_complains.php"><i class="icon-double-angle-right"></i>Complains</a></li>
											<li><a href="AdminFiles/Q_suggestion.php"><i class="icon-double-angle-right"></i>Suggestions</a></li>
											<li><a href="AdminFiles/Q_inquiry.php"><i class="icon-double-angle-right"></i>Inquiries</a></li>
											<li><a href="AdminFiles/Q_recommendation.php"><i class="icon-double-angle-right"></i>Recommendations</a></li>
											<li><a href="AdminFiles/f_corruption.php"><i class="icon-double-angle-right"></i>Reported Corruption</a></li>
											<li><a href="AdminFiles/Q_disaster.php"><i class="icon-double-angle-right"></i>Disasters</a></li>
										</ul>
									</li>
									<li>
							...
							<div id="main-content" class="clearfix">
								...
								<div id="page-content" class="clearfix">
									...
									$resultc = mysql_query("SELECT * FROM s_complains where Q_comment = '' AND Status=''");
									$comp =mysql_num_rows($resultc);
									$resultcr = mysql_query("SELECT * FROM s_corruption where Q_comment = '' AND Status=''");
									$corr =mysql_num_rows($resultcr);
									$resulti = mysql_query("SELECT * FROM s_inquiries where Q_comment = '' AND Status=''");
									$inqr =mysql_num_rows($resulti);
									$results = mysql_query("SELECT * FROM s_suggestion  where Q_comment = '' AND Status=''");
									$sugg =mysql_num_rows($results);
									$resultr = mysql_query("SELECT * FROM s_recommendation  where Q_comment = '' AND Status=''");
									$recmm =mysql_num_rows($resultr);
									$resultd = mysql_query("SELECT * FROM s_disaster where Q_comment = '' AND Status=''");
									...
									<a class="muted" href="#comp" data-toggle="tab">
										...
										<a class="muted" href="#sugg" data-toggle="tab">
											...
											<a class="muted" href="#inqr" data-toggle="tab">
												...
												<a class="muted" href="#recmm" data-toggle="tab">
													...
													<a class="muted" href="#disas" data-toggle="tab">
														...
														<div class="span11">
															...
															<div class="widget-box transparent">
																...
																<div class="widget-body">
																	<div class="widget-main no-padding">
																		<div class="tab-content no-padding">
																			...
																			<div id="comp" class="tab-pane">
																				...
																				<?php
																				$query = "SELECT * FROM s_complains where Q_comment = '' AND Status='' order by date_saved desc ";
																				...
																				<a href="AdminFiles/Q_complains.php" class="btn btn-minier btn-info"><i class="icon-only icon-share-alt"></i></a>
																			</div>';
																			echo '</div>';
																			echo '</div>';
																			echo '</div>';
																	...
																	<div id="disas" class="tab-pane">
																		...
																		<?php
																		$query = "SELECT * FROM s_disaster where Q_comment = '' AND Status=''  order by date_saved desc";
																		...
																		echo '<div class="text">'.$message .'</div>';
																		echo '<div class="tools">
																		<a href="AdminFiles/Q_disaster.php" class="btn btn-minier btn-info"><i class="icon-only icon-share-alt"></i></a>
																	</div>';
																	echo '</div>';
																	echo '</div>';
																	echo '</div>';
															...
															<div id="inqr" class="tab-pane">
																...
																<?php
																$query = "SELECT * FROM s_inquiries where Q_comment = '' AND Status='' order by date_saved desc ";
																...
																echo '<div class="text">'.$message .'</div>';
																echo '<div class="tools">
																<a href="AdminFiles/Q_inquiry.php" class="btn btn-minier btn-info"><i class="icon-only icon-share-alt"></i></a>
															</div>';
															echo '</div>';
															echo '</div>';
															echo '</div>';
													...
													<div id="recmm" class="tab-pane">
														...
														<?php
														$query = "SELECT * FROM s_recommendation where Q_comment = '' AND Status=''  order by date_saved desc  ";
														...
														echo '<div class="text">'.$message .'</div>';
														echo '<div class="tools">
														<a href="AdminFiles/Q_recommendation.php" class="btn btn-minier btn-info"><i class="icon-only icon-share-alt"></i></a>
													</div>';
													echo '</div>';
													echo '</div>';
													echo '</div>';
											...
											<div id="sugg" class="tab-pane">
												...
												<?php
												$query = "SELECT * FROM s_suggestion where Q_comment = '' AND Status=''  order by date_saved desc  ";
												...
												echo '<div class="text">'.$message .'</div>';
												echo '<div class="tools">
												<a href="AdminFiles/Q_suggestion.php" class="btn btn-minier btn-info"><i class="icon-only icon-share-alt"></i></a>
											</div>';
											echo '</div>';
											echo '</div>';
											echo '</div>';
									...
									<div id="corr" class="tab-pane">
										...
										echo '<div class="text">'.$message .'</div>';
										echo '<div class="tools">
										<a href="AdminFiles/Q_corruption.php" class="btn btn-minier btn-info"><i class="icon-only icon-share-alt"></i></a>
									</div>';
									echo '</div>';
									echo '</div>';
									echo '</div>';
