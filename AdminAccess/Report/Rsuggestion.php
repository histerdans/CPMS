...
class PDF extends PDF_MySQL_Table
{
	...
	//Title
		...
		$this->Cell(0,6,'Responded Suggestions Report',0,1,'C');
		$this->Ln(10);
...
$pdf->Output($downloadfilename."RepliedSuggestions.pdf"); 




header('Location: '.$downloadfilename."RepliedSuggestions.pdf");
?>
