...
class PDF extends PDF_MySQL_Table
{
	...
	//Title
		...
		$this->Cell(0,6,'Pending Suggestions Report',0,1,'C');
		$this->Ln(10);
...
$pdf->Table("SELECT Constituency,Ward,issue,description,date_saved from s_suggestion where Q_comment = '' AND fwd_to='$role' AND f_Ministry='$dep' AND f_Constituency='$const' order by date_saved",$prop);
$pdf->AddPage('L');
...
$pdf->Output($downloadfilename."PendingSuggestion.pdf"); 




header('Location: '.$downloadfilename."PendingSuggestion.pdf");
?>
