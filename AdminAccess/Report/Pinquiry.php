...
class PDF extends PDF_MySQL_Table
{
	...
	//Title
		...
		$this->Cell(0,6,'Pending Inquiries Report',0,1,'C');
		$this->Ln(10);
...
$pdf->Table("SELECT Constituency,Ward,issue,description,date_saved from s_inquiries where Q_comment = '' AND fwd_to='$role' AND f_Ministry='$dep' OR f_Constituency='$const' order by date_saved",$prop);
$pdf->AddPage('L');
...
$pdf->Output($downloadfilename."PendingQuestions.pdf"); 




header('Location: '.$downloadfilename."PendingQuestions.pdf");
?>
